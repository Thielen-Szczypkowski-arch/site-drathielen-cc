...
def build_post_html(meta, body_md, slug):
...
def main():
    ...
    for post_path in posts:
        ...
        # Gera HTML do post
        post_html = build_post_html(meta, body_md, slug)
